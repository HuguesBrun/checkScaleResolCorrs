...
class rochcor2015 {
 public:
  ...
  void momcor_mc(TLorentzVector&, float, int, float&, bool);
  void momcor_data(TLorentzVector&, float, int, float&);
  void momcor_dataInv(TLorentzVector&, float, int, float&);
 ...
 private:
  ...
  static constexpr double mgscl_stat = 4.34252e-05 ; //stat. error of global factor for mass peak in MC
  static constexpr double mgscl_syst = 3.81651e-03; //syst. error of global factor for mass peak in MC
  static constexpr double dgscl_stat = 4.04193e-05; //stat. error of global factor for mass peak in data
