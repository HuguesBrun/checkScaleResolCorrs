...
namespace muon_pog {
  ...
  public:
    ...
    Float_t pt_RocAfterMCscale;
    Float_t pt_RocAfterMCsmear;
    Float_t pt_RocBeforeDataScale;
    Float_t pt_RocDataReversed;
    Float_t pt_RocBeforeDataScaleMCsmeared;


    Float_t pt_KalAfterMCscale;
    Float_t pt_KalAfterMCsmear;
    Float_t pt_KalBeforeDataScale;
    Float_t pt_KalDataReversed;
    Float_t pt_KalBeforeDataScaleMCsmeared;
